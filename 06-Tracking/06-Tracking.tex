...
The small bias in reconstructed momentum and transverse momentum did not give rise to significant effects in the analysis and was considered in systematic error studies.
\begin{figure}
  \begin{center}
    \begin{tabular}{cc}
  ...
  \caption{
    ...
    Predicted momentum reconstruction resolution (left) and bias
...
\begin{figure}
  ...
  \caption{
    %Upstream tracker: from simulated data.
    Predicted momentum reconstruction resolution (left) and
...
The dowels were used to locate the trackers precisely with respect to
...
\begin{figure}
  ...
  \end{center}
  \caption{
    Consistency of the alignment algorithm results across runs acquired during
