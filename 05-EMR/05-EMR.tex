...
\begin{figure}[htb!]
  ...
  \caption{
    ...
    structure from a top perspective (right).
...
MAPMT used, with an average of $0.20\pm0.03$\%
...
comparable quantities, as well as a smaller number of electrons.
...
The quality of this statistical test was characterised in terms of
