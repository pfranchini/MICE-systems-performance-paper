...
For our steady state condition the liquid-hydrogen was close to the boiling temperature of liquid parahydrogen~\cite{NOTE524}. The average temperature of the eight sensors during steady-state was (20.51\,$\mathrm{\pm}$\,0.07)\,K at 1.085\,Bar and allows us to determine the uncertainty in the density as (70.53\,$\mathrm{\pm}$\,0.08)\,kg/m$^{3}$
...
The energy loss is momentum dependent as each particle will lose a different amount of energy passing through the absorber. Tables \ref{tab:Aluminium} and \ref{tab:Hydrogen} show the energy loss at various nominal muon momenta and densities of Aluminium and liquid-hydrogen~\cite{AtomicAluminium}\cite{AtomicHydrogen}\cite{MuonAluminium}\cite{MuonliquidHydrogen}. 277\,MeV/$c$ and 344\,MeV/$c$ are the minimum ionization momenta of Aluminium and liquid-hydrogen respectively.
