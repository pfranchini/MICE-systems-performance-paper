...
The absorber vessel comprise a cylindrical aluminium body sealed with
...
\end{figure}
The absorber vessel was specified to contains 22\,l of liquid, so
...
The boiling point of hydrogen at 1.085\,Bar is 20.511\,K (figure~\ref{Fig:TempCalibrated}). There are however a number of uncertainties.
...
For our steady state condition the liquid-hydrogen was close to the boiling temperature of liquid parahydrogen~\cite{NOTE524}. The average temperature of the eight sensors during steady-state was (20.51\,$\mathrm{\pm}$\,0.07)\,K at 1.085\,Bar and allows us to determine the uncertainty in the density
as (70.53\,$\mathrm{\pm}$\,0.08)\,kg/m$^{3}$
...
The pressure sensors are accurate to $\mathrm{\pm}$\,5\,mBar (0.25\% of 2\,Bar). At (1085\,$\mathrm{\pm}$\,5)\,mBar, the typical MICE operating pressure, this corresponds to a deflection of (0.5374\,$\mathrm{\pm}$\,0.1076)\,mm (model uncertainty) $\mathrm{\pm}$\,0.0022\,mm (sensor uncertainty) at the centre of
the absorber window.
...
At the centre of the absorber, the total amount of aluminium the muon beam passes through is (785\,$\mathrm{\pm}$\,13)\,$\mu$m, a variance of 1.68\%. However, as the windows were thin, the effects on energy loss are negligible. A 200\,MeV/$c$ muon passing
...
The energy loss is momentum dependent as each particle will lose a different amount of energy passing through the absorber. Tables \ref{tab:Aluminium} and \ref{tab:Hydrogen} show the energy loss at various momenta and densities of Aluminium and liquid-hydrogen~\cite{AtomicAluminium}\cite{AtomicHydrogen}\cite{MuonAluminium}\cite{MuonliquidHydrogen}. 277\,MeV/$c$ and 344\,MeV/$c$ are the minimum ionization momenta of Aluminium and liquid-hydrogen respectively.
