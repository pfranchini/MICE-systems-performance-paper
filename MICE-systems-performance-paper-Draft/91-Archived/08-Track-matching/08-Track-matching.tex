...
%... <remnove the last sentence?
\end{itemize}
The final cut restricted the sample to events in which particles were contained within the active area of the experiment and ensured that the selection was consistent across the configurations in which data were taken.
