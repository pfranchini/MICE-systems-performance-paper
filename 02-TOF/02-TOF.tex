...
\begin{figure}[!ht]
  \begin{center}
    ...
    \caption{MICE experiment in the Step~IV configuration, showing the full beam line starting from the target position on the proton synchrotron) with the full set of quadrupoles and dipoles (Q1 to Q9, D1/2), the Decay Solenoid, and cooling channel elements with all the detectors.}
    \label{fig:BL}
  \end{center}
\end{figure}
