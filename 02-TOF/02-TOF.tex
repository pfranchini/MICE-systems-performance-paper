...
The time of flight between the first pair of TOF stations (figure~\ref{fig:TOF_peaks}), considering the momentum selection operated by the beamline dipoles D1 and D2, provided particle identification information and, assuming particles mass for each distribution, can also be used to infer the momentum.
...
%All stations were exposed to residual magnetic fields: TOF0 was placed in a relatively low residual field produced by the last quadrupole magnet of the beam line (which had mirror plates installed), while the other two TOF stations were exposed to the stray fields of the cooling channel solenoids.
...
%Which PMT channel's threshold crossing caused the readout was dependent on where the particle crossed through the TOF1 station.
...
Further calibrations were needed in order to take into account the
...
they
%all centre approximately at 0\,ns and they
