...
The refractive indices than can be calculate from the turn on point ($n =  \sqrt{1+\frac{1}{\beta_0^2\gamma_0^2}}$) are compatible with the nominal values quote before.
